...
export function HeroSection() {
  ...
  return (
    <section ref={heroRef} className="pt-32 pb-16 lg:pt-40 lg:pb-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-2xl">
            <div
              className={`inline-flex items-center gap-2 px-4 py-2 bg-secondary rounded-sm mb-8 transition-all duration-700 ${
            ...
            <h1
              className={`text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-balance mb-6 lg:mb-8 transition-all duration-700 ${
            ...
            <p
              className={`text-lg md:text-xl text-muted-foreground leading-relaxed text-pretty mb-10 lg:mb-12 transition-all duration-700 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
        ...
        <div
          className={`grid grid-cols-2 lg:grid-cols-4 gap-8 mt-16 lg:mt-24 pt-12 border-t border-border transition-all duration-700 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        ...
        >
          {[
            ...
            <div key={index} className="group cursor-default" style={{ transitionDelay: `${600 + index * 100}ms` }}>
              <div className="text-3xl lg:text-4xl font-bold text-foreground mb-2 group-hover:text-accent transition-colors">
                {stat.value}
              </div>
